0-hello_world -script that prints “Hello, World” and a new line to the standard output.
...
7. It is a good file that cuts iron without making a noise- Write a shell script that creates a file named \*\'Best School\'\*$\?\*\*\*\*\*:) containing the text Best School ending by a new line.
